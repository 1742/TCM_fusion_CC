...
from tools.fit import fit_FusionNet_without_adaptive_weights
...
if __name__ == '__main__':
    ...
    model = MI_model(se_resnet34(include_top=False), num_classes=len(refer_labels))
    ...
    for k, dataset in folds.items():
        ...
        effect = fit_FusionNet_without_adaptive_weights(
            device=device,
            model=model,
            train_num=train_num,
            val_num=val_num,
